package com.example.andy.helloworld;
...
public class MainActivity extends AppCompatActivity {
    ...
    the next activity uses the key to retrive the text value. It's a good practice to define keys
    for intent extras using your app's package name as a prefix. This ensures the keys are unique,
